...
*/
    ...
    */
    ...
    $this->admin_option('General',
        ...
        'raw', '<div class="tt-notice">You can buy this theme without footer links online at <a href="http://fthemes.com/buy/?theme=' . $the_theme_slug_url . '" target="_blank">http://fthemes.com/buy/?theme=' . $the_theme_slug_url . '</a><br />Upgrading is easy. You will NOT lose your current settings or already made customizations.</div>', 
        array('priority' => '1')
    ); //the_theme_slug_url
