<?php
    ...
    class Themater_FeaturedPosts
    {
        ...
        var $defaults = array(
            ...
            'enabled_positions' => array('homepage'=>'Homepage', 'categories' => 'Category Pages', 'tags' => 'Tag Pages', 'archives' => 'Archive Pages', 'single' => 'Single Posts', 'pages' => 'Pages', 'searches'=>'Search Results Pages'),
                        ...
                        if($featuredposts_query) {
                            ...
                            if (have_posts()) : while (have_posts()) : the_post();
                                ...
                                if ( has_post_thumbnail()) {
                                   $get_large_image_url = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'large');
