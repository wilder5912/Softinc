...
$(document).ready(function() {  
    //<!--      Activamos la validaci�n sobre el formulario -->  
    ...
    //<!--  Cu�ndo hagamos clic en el enlace manual mostraremos el n�mero de errores del formulario -->  
    $("#manual").click(function() {  
          alert("�Formulario v�lido?: " + $("#entityDataForm").validate().form());  
          alert("Existen " + $("#entityDataForm").validate().numberOfInvalids() + " errores.");    
    });  
      
    //<!--  Cu�ndo hagamos clic en el enlace addRule agregaremos una regla de validaci�n al campo con identificador campoX -->  
