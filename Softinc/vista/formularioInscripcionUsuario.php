...
<tr>
	<td><input type ='text'  name='CiUsuario' size='40' min="1" max="10" maxlength='7' placeholder="CI: 2415125"  pattern="([0-9]{7})" required />
	</td>
</tr>
<tr>
        <td><input type ='text'  name='unidadEducativaUsuario' size='40'  maxlength='40' placeholder="Institucion" required   />
	</td>
</tr>

<tr>
    <td><input type ='text'  name='fechaUsuario' id='inputField' size='40' maxlength='40' placeholder="Fecha de nacimiento" required pattern="\d{4}-\d{1,2}-\d{1,2}" />
	</td>
</tr>
...
<tr>
    <td>
  <div>
    <button type="submit">Abrir una cuenta</button>
  </div>
       </td> 
</tr>
</table>
